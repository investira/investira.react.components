...
import { default as WSelect } from "@mui/material/Select";
import {
  InputLabel,
  FormControl,
  FormHelperText,
...
function Select(props) {
  ...
  return (
    <FormControl {...props.formControlProps} className={classes.formControl}>
      {props.label && (
      ...
      {props.helperText && <FormHelperText>Label + placeholder</FormHelperText>}
    </FormControl>
  );
}
